...
label1 = tk.Label(root, image=random.choice([bgImage, bgImage1, bgImage2]))
label1.pack()
backSymbol = PhotoImage(file="BackButton.png")
logInSymbol = PhotoImage(file="Login.png")
logOutSymbol = PhotoImage(file="Logout.png")
...
forgetPasswordButton.place(x=608, y=500, anchor=tk.CENTER)
logInButton = tk.Button(root, text="Log in", bg="white", fg="black", image=logInSymbol, compound="left", cursor="hand2", command=logInButtonFunction)
logInButton.place(x=330, y=550, anchor=tk.CENTER)
...
backButton = tk.Button(root, text="Back", fg="black", bg="white", font=("Helvetica", 12), image=backSymbol, cursor="hand2", command=signUpBackFunction)
...
logOutButton = tk.Button(root, text="Log Out", bg="white", fg="black", font=("Helvetica", 12), image=logOutSymbol, compound="right", cursor="hand2", command=logOutButtonFunction)
...
deleteBackButton = tk.Button(root, text="Back", bg="white", fg="black", font=("Helvetica", 12), image=backSymbol, cursor="hand2", command=signUpBackFunction)
...
forgetBackButton = tk.Button(root, text="Back", bg="white", fg="black", font=("Helvetica", 12), image=backSymbol, cursor="hand2", command=signUpBackFunction)
...
confirmBackButton = tk.Button(root, text="Back", bg="white", fg="black", font=("Helvetica", 12), image=backSymbol, command=signUpBackFunction)
root.mainloop()
